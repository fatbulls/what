      ...
      <div className="w-full mx-auto shadow-sm">
        <div className="mb-8 text-center">
          <h1 className="text-2xl lg:text-3xl font-bold text-heading">
            {t("text-thank-you", { defaultValue: "Thank you, your order is confirmed" })}
          </h1>
          <p className="text-body mt-2 text-sm lg:text-base">
            {t("text-order-confirmation-blurb", {
              defaultValue: "We've received your order and sent a confirmation to your email. We'll reach out if we need anything else.",
            })}
          </p>
        </div>
        ...
        <div className="grid gap-4 lg:gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-11">
          ...
          <div className="p-5 md:p-6 border border-gray-100 bg-gray-200 rounded-md shadow-sm">
            ...
            { order?.payment_gateway === 'DIRECT_BANK_TRANSFER' && (
            <div>
              ...
              <div className="text-sm leading-8">
                <Link
                    href="https://assets.becauseyou.com.my/assets/images/qr-duitnow.png"
                    className="inline-block text-rose-600 focus:outline-none hover:underline"
                    target="_blank"
                >
                  {'Click to view Duitnow QR Code'}
                </Link>
              </div>
            </div>
            )}
