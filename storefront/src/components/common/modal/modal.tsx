...
type ModalProps = {
  ...
  // Hide the floating "X" close button. Clicking the backdrop still
  // closes the modal — used for auth flows where we want the user to
  // commit to the action via the form rather than bail via X.
