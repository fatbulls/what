...
export const promotionBanner = [
  {
    ...
    image: {
      mobile: {
        url: "https://assets.becauseyou.com.my/assets/images/fresh-flower-min.jpg",
        width: 450,
        height: 180,
      },
      desktop: {
  ...
  },
  {
    ...
    image: {
      mobile: {
        url: "https://assets.becauseyou.com.my/assets/images/premium-design-min.jpg",
        width: 450,
        height: 180,
      },
      desktop: {
  ...
  },
  {
    ...
    image: {
      mobile: {
        url: "https://assets.becauseyou.com.my/assets/images/sameday-delivery-min.jpg",
        width: 450,
        height: 180,
      },
      desktop: {
...
export const modernDemoProductBanner = [
  {
    ...
    image: {
      mobile: {
        url: "https://assets.becauseyou.com.my/assets/images/promo_code-min.jpg",
        width: 430,
        height: 600,
      },
      desktop: {
