...
const showIds = [9, 10, 11, 12, 13, 14, 15, 16];
...
const CategoryBlock: React.FC<CategoriesProps> = ({
  ...
  // The original ChawkBazar code filtered by hardcoded integer IDs
  // (`showIds = [9..16]`) tied to the becauseyou Laravel backend. Medusa
  // uses string IDs (`pcat_…`) so that filter excluded everything. Show all
  // fetched categories instead.
